function extract_interleaved_simulation(saveFolder, organizeData_saveFolder)
%%%%%% This function extracts useful information from the output of
%%%%%% Bayesian model. It does so for all files in one folder and save the
%%%%%% organized data in another folder
                    ...
                    idx = find(strcmp(imagetask, imagetask_list{i}) & ...
                      ...
                      for k = 1:numel(idx)
                          for t = 1:numel(timeBin_list)
                            ...
                            if isfield(dat.Projection, 'prior')
