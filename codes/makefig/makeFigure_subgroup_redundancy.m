...
plotOptions.group   = 'two_opposite'; %'high_low', 'consistent_opposite','two_opposite'
...
switch plotOptions.group
    case 'high_low'
        ...
        if  plotOptions.dosize_control
            save_name = fullfile(save_folder, sprintf('informationRedundancy_percent_high_low_%s_sizeControl.svg', plotOptions.source));
        else
            save_name = fullfile(save_folder, sprintf('informationRedundancy_percent_high_low_%s.svg', plotOptions.source));
        end
    ...
    case 'consistent_opposite'
        ...
        if plotOptions.dosize_control
            save_name = fullfile(save_folder, sprintf('informationRedundancy_percent_consistent_opposite_%s_sizeControl.svg', plotOptions.source));
        else
            save_name = fullfile(save_folder, sprintf('informationRedundancy_percent_consistent_opposite_%s.svg', plotOptions.source));
        end
    ...
    case 'two_opposite'
        ...
        if  plotOptions.dosize_control
            save_name = fullfile(save_folder, sprintf('informationRedundancy_percent_two_opposite_%s_sizeControl.svg', plotOptions.source));
        else
            save_name = fullfile(save_folder, sprintf('informationRedundancy_percent_two_opposite_%s.svg', plotOptions.source));
        end
