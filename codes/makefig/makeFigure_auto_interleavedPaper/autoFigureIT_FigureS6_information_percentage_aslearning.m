...
save_name = fullfile(save_folder,'Figure_S6_I_redundancy_interleaved_sizeControl_interleaved.svg');
tex_name = fullfile(save_folder,'Figure_S6_I_redundancy_interleaved_sizeControl_report.tex');

tex_bar_name = fullfile(save_folder,'Figure_S6_I_redundancy_interleaved_sizeControl_report_bar.tex');
...
ylabel('$I_\textrm{redundancy}$','Interpreter','latex','fontsize',ftsize+2)
...
plotOptions.dataStr = 'combine_delta';
plotOptions.tBin_toPlot = 0;
plotOptions.sessionType = 'mainTask';
plotOptions.plotInterleaved = 0;
...
set(gca,'TickDir','out','fontsize',ftsize)
text(0.015,0.007, sprintf('$r(%d) = %.2f^{%s}$', stats_info.df, stats_info.r, fig.p2star(stats_info.p)),...
...
set(gca,'TickDir','out','fontsize',ftsize)
text(0.035,0.02, sprintf('$r(%d) = %.2f^{%s}$', stats_info.df, stats_info.r, fig.p2star(stats_info.p)),...
...
title('Cardinal Task','Color',bpGlobal.color_list.color_cardinal, 'fontsize', ftsize,'FontWeight','bold');
set(gca,'TickDir','out','fontsize',ftsize)
text(0.06,0.0075, sprintf('$r(%d) = %.2f^{%s}$', stats_info.df, stats_info.r, fig.p2star(stats_info.p)),...
    'Color',bpGlobal.color_list.color_cardinal, 'fontsize', ftsize,'Interpreter','latex')
ylabel('$I_\textrm{redundancy}$','Interpreter','latex','fontsize',ftsize+2)
...
title('Oblique Task','Color',bpGlobal.color_list.color_oblique, 'fontsize', ftsize,'FontWeight','bold');
set(gca,'TickDir','out','fontsize',ftsize)
text(0.035,0.008, sprintf('$r(%d) = %.2f^{%s}$', stats_info.df, stats_info.r, fig.p2star(stats_info.p)),...
    'Color',bpGlobal.color_list.color_oblique, 'fontsize', ftsize,'Interpreter','latex')
