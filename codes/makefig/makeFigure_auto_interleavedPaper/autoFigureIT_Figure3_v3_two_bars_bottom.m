...
save_name   = fullfile(save_folder,'v3_Figure_3_informationRedundancy_percent_twobars_bottom.svg');
tex_name    = fullfile(save_folder ,'v3_Figure_3_informationRedundancy_percent_twobars_bottom.tex');
...
[~,~,stats_info_avg] = fig_it.plot_bar_cross_deltaInfo(results_all_high, session_list_plot, plotOptions);

stats_redundacy_within_cross_string_monkeyR_avg_high = sprintf(['Monkey R avg, high-sensitivity $I_\\textrm{redundacy}$, within v.s. cross: $t(%d) = %.2f$, $p = \\num{%.2e}$ \n',...
...
session_list_plot = bpGlobal.rolo.session_list.switching;
[~,~,stats_info_avg] = fig_it.plot_bar_cross_deltaInfo(results_all_low, session_list_plot, plotOptions);
stats_redundacy_within_cross_string_monkeyR_avg_low = sprintf(['Monkey R avg, low-sensitivity $I_\\textrm{redundacy}$, within v.s. cross: $t(%d) = %.2f$, $p = \\num{%.2e}$ \n',...
                                        'Within-redundancy: $Mean = %.2f$, $std = %.2f$' ...
                                        'Cross-redundancy: $Mean = %.2f$, $std = %.2f$ \n'], ...
                                        stats_info_avg.df, stats_info_avg.tstat, stats_info_avg.p_value,...
                                        stats_info_avg.mu_within, stats_info_avg.std_within,...
...
stats_redundacy_within_cross_string_monkeyG_avg_high = sprintf(['Monkey G avg, high-sensitivity $I_\\textrm{redundacy}$, within v.s. cross: $t(%d) = %.2f$, $p = \\num{%.2e}$ \n',...
                                        'Within-redundancy: $Mean = %.2f$, $std = %.2f$' ...
                                        'Cross-redundancy: $Mean = %.2f$, $std = %.2f$ \n'], ...
                                        stats_info_avg.df, stats_info_avg.tstat, stats_info_avg.p_value,...
                                        stats_info_avg.mu_within, stats_info_avg.std_within,...
...
stats_redundacy_within_cross_string_monkeyG_avg_low = sprintf(['Monkey G avg, low-sensitivity $I_\\textrm{redundacy}$, within v.s. cross: $t(%d) = %.2f$, $p = \\num{%.2e}$ \n',...
                                        'Within-redundancy: $Mean = %.2f$, $std = %.2f$' ...
                                        'Cross-redundancy: $Mean = %.2f$, $std = %.2f$ \n'], ...
                                        stats_info_avg.df, stats_info_avg.tstat, stats_info_avg.p_value,...
                                        stats_info_avg.mu_within, stats_info_avg.std_within,...
...
fwrite(fid,[ 'Redundancy in percentage: \n'...
            stats_redundacy_within_cross_string_monkeyR_avg_high, stats_redundacy_within_cross_string_monkeyR_avg_low,...
            stats_redundacy_within_cross_string_monkeyG_avg_high, stats_redundacy_within_cross_string_monkeyG_avg_low]);
fclose(fid);