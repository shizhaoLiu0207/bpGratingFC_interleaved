...
% 
% versionName_list = {'all_trials_highC_highO_lowC_lowO_mainTask_sizeControl';...
%     'all_trials_highC_lowO_lowC_highO_mainTask_sizeControl'};
% versionName_list =  {'all_trials_highC_highO_passiveViewing_sizeControl';'all_trials_lowC_lowO_passiveViewing_sizeControl';...
%      'all_trials_highC_highO_mainTask_sizeControl';'all_trials_lowC_lowO_mainTask_sizeControl'};
versionName_list = {'all_trials_highC_lowO_passiveViewing_sizeControl';'all_trials_lowC_highO_passiveViewing_sizeControl'};
