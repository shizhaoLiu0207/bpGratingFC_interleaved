...
nSession                  = 3; % 01/18/2026. Add an option to run multiple sessions 
        ...
        for n = 1:nStim
            ...
            for m = 1:nDelta
                for t = 1:nSession
                    ...
                    save_name_cardinal = sprintf('synthetic_data_cardinal_bPF_%s_taskprior_%s_delta_%s_contrast_%d_%d_rep_%d.mat', ...
                                            b_PF_str, prior_str, delta_str, stimulus_contrast(1),  stimulus_contrast(2), t);
    
                    save_name_oblique = sprintf('synthetic_data_oblique_bPF_%s_taskprior_%s_delta_%s_contrast_%d_%d_rep_%d.mat', ...
                                            b_PF_str, prior_str, delta_str, stimulus_contrast(1),  stimulus_contrast(2), t);
